        ...
        <div className="py-2 w-full fixed z-10 border-b-2 mb-4 bg-opacity-100 bg-[#08081c]">
            <div className="w-full px-3">
                ...
                <div className="float-right  flex gap-3">
                    <button type='button' className='bg-blue-900 hover:bg-green-700 text-white px-2 rounded-lg'>
                       XP : 3000 Pts
                    </button>
                    <button type='button' className='bg-green-700 hover:bg-green-700 text-white px-2 rounded-lg'>
                       Balance : 100 RCs
                    </button>
